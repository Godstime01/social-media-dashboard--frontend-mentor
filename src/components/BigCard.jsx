...
const BigCard = (props) => {
  return (
    <div className='p-5 group cursor-pointer transition-colors dark:hover:bg-blue-300/50  shadow-md rounded-md bg-blue-200 hover:bg-blue-500/60 dark:bg-blue-400 dark:text-white flex flex-col items-center text-center gap-3'>
